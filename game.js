...
function end(text){over=!0;ol.style.display="flex";msg.innerHTML=text;sub.textContent="";rst.style.display="block";}
...
function draw(){
    ...
    ctx.fillStyle="#fff8d6";ctx.fillRect(0,0,W,H);
    ctx.fillStyle="#ffecd1";ctx.fillRect(0,groundY,W,groundHeight);
